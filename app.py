...
def get_anwer_openai(quastion):
    completion = openai.ChatCompletion.create(
                model="gpt-3.5-turbo",
                messages = [{"role": "system", "content" : "I want you to act like an expert market investigator chatbot and help merchants and traders with their query"},
                            {"role": "user", "content" : "Give a Brif Of Current market situation in India"},
